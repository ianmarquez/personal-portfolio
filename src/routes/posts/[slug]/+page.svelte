...
<section class="max-w-4xl mx-auto">
  ...
  <hgroup class="flex flex-col items-start justify-end">
    <PostCard title={data.meta.title} categories={data.meta.categories} date={data.meta.date} />
  </hgroup>
  ...
  <a
    ...
    <span>Markdown styling by:</span>
    <iconify-icon icon="bi-github" />
    <span>sindresorhus/github-markdown-css</span>
  </a>
</pre>
</section>
