...
<div class="max-w-6xl flex flex-col gap-5 mx-auto my-10">
  <div class="flex flex-col gap-1">
    ...
    <p class="text-secondary text-sm underline underline-offset-1"><a href="mail:regilmarquez123@gmail.com">regilmarquez123@gmail.com</a></p>
  </div>
    ...
    working in the back-end using Node.js. Currently leaning towards backend
